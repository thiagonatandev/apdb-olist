...
TABLE olist_geolocation_dataset CHARACTER SET utf8 FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n\n' IGNORE 1 ROWS (
    geolocation_zip_code_prefix,
    geolocation_lat,
    geolocation_lng,
    geolocation_city,
...
TABLE olist_order_customer_dataset CHARACTER SET utf8 FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n\n' IGNORE 1 ROWS (
    customer_id,
    customer_unique_id,
...
TABLE olist_sellers_dataset CHARACTER SET utf8 FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n\n' IGNORE 1 ROWS (
    seller_id,
...
TABLE olist_products_dataset CHARACTER SET utf8 FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n\n' IGNORE 1 ROWS (
    product_id,
...
TABLE product_category_name_translation CHARACTER SET utf8 FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n\n' IGNORE 1 ROWS (
    product_category_name,
    product_category_name_english
);

LOAD DATA LOCAL INFILE '/home/oagarian/bcdd/olist_orders_dataset.csv' INTO
TABLE olist_orders_dataset CHARACTER SET utf8 FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n\n' IGNORE 1 ROWS (
    order_id,
    customer_id,
    order_status,
...
TABLE olist_order_items_dataset CHARACTER SET utf8 FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n\n' IGNORE 1 ROWS (
    order_id,
    order_item_id,
    product_id,
    seller_id,
...
TABLE olist_order_payments_dataset CHARACTER SET utf8 FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n\n' IGNORE 1 ROWS (
    order_id,
    payment_sequential,
    payment_type,
...
TABLE olist_order_reviews_dataset CHARACTER SET utf8 FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n\n' IGNORE 1 ROWS (
    review_id,
    order_id,
    review_score,
